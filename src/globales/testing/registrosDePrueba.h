...
void cargarDatosDePrueba(){
    ...
    // FECHAS DESDE NOV 2025 HASTA FEB 2026
    int factDia[]  = { 5, 12, 20, 28,  5, 13, 22,  3, 15,   2, 10, 18, 19, 21, 20, 22, 19, 21};
    int factMes[]  = {11, 11, 11, 11, 12, 12, 12,  1,  1,   2,  2,  2,  2,  2,  2,  2,  2,  2};
